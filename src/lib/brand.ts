...
export const BRAND_LOGO_PATH = "/images/brand/ks-choco-house-logo.png";
export const BRAND_LOGO_FILE_PATH = "public/images/brand/ks-choco-house-logo.png";
export const BRAND_LOGO_MIME_TYPE = "image/png";
